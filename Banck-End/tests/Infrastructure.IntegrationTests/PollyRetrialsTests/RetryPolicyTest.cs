using System.Net;
using Totvs.Ats.Infrastructure.IntegrationTests.PollyRetrialsTests;
...
namespace Totvs.Ats.Infrastructure.IntegrationTests.PollyRetrialsTests;
...
public class RetryPolicyTest
{
    ...
    public async Task WHEN_success_response_is_received_THEN_no_retrials_are_made(HttpStatusCode statusCode)
    {
        ...
        await testApiClient.UpdateApplicant(applicantId: Guid.NewGuid(), unitsChange: 2);
    ...
    private static IApplicantClient SetupClientAsInDependencyInjection(HttpMessageHandler messageHandler)
    {
        ...
        servicesCollection.AddHttpClient<IApplicantClient, ApplicantClient>(
                              client =>
                              {
        ...
        return serviceProvider.GetRequiredService<IApplicantClient>();
    }
